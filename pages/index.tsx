...
export default function Home() {
  ...
  const saveCurrentChat = () => {
    ...
    if (!updatedHistories.some(chat => chat.id === currentChatId) && currentChatId) {
        const newChat: ChatHistoryItem = { id: currentChatId, title: chatTitle, messages };
        updatedHistories.push(newChat);
    }
